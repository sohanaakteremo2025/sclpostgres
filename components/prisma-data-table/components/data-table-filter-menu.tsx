...
}: DataTableFilterItemProps<TData>) {
	{
		...
		return (
			<div
				...
				role="listitem"
				id={filterItemId}
				className="flex h-8 items-center rounded-md bg-white dark:bg-neutral-950"
			...
			>
				<Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
					<PopoverTrigger asChild>
						<Button
							variant="ghost"
							size="sm"
							className="rounded-none rounded-l-md border border-neutral-200 border-r-0 font-normal dark:bg-neutral-200/30 dark:border-neutral-800 dark:dark:bg-neutral-800/30"
						>
							{columnMeta?.icon && (
								<columnMeta.icon className="text-neutral-500 dark:text-neutral-400" />
							)}
				...
				<Button
					...
					variant="ghost"
					size="sm"
					className="h-full rounded-none rounded-r-md border border-neutral-200 border-l-0 px-1.5 font-normal dark:bg-neutral-200/30 dark:border-neutral-800 dark:dark:bg-neutral-800/30"
	...
	if (filter.operator === 'isEmpty' || filter.operator === 'isNotEmpty') {
		return (
			<div
				...
				aria-live="polite"
				className="h-full w-16 rounded-none border border-neutral-200 bg-transparent px-1.5 py-0.5 text-neutral-500 dark:bg-neutral-200/30 dark:border-neutral-800 dark:text-neutral-400 dark:dark:bg-neutral-800/30"
			/>
		)
	}
				...
				<Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
					<PopoverTrigger asChild>
						<Button
							...
							variant="ghost"
							size="sm"
							className="h-full min-w-16 rounded-none border border-neutral-200 px-1.5 font-normal dark:bg-neutral-200/30 dark:border-neutral-800 dark:dark:bg-neutral-800/30"
						>
										...
										{selectedOptions.map(selectedOption =>
											selectedOption.icon ? (
												<div
													...
													className="rounded-full border border-neutral-200 bg-white p-0.5 dark:border-neutral-800 dark:bg-neutral-950"
												>
				...
				<Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
					<PopoverTrigger asChild>
						<Button
							...
							size="sm"
							className={cn(
								'h-full rounded-none border border-neutral-200 px-1.5 font-normal dark:bg-neutral-200/30 dark:border-neutral-800 dark:dark:bg-neutral-800/30',
								!filter.value && 'text-neutral-500 dark:text-neutral-400',
							)}
						>
