		...
		>
			...
			<SortableOverlay>
				<div className="flex items-center gap-2">
					<div className="h-8 min-w-[72px] rounded-sm bg-neutral-900/10 dark:bg-neutral-50/10" />
					<div className="h-8 w-32 rounded-sm bg-neutral-900/10 dark:bg-neutral-50/10" />
					<div className="h-8 w-32 rounded-sm bg-neutral-900/10 dark:bg-neutral-50/10" />
					<div className="h-8 min-w-36 flex-1 rounded-sm bg-neutral-900/10 dark:bg-neutral-50/10" />
					<div className="size-8 shrink-0 rounded-sm bg-neutral-900/10 dark:bg-neutral-50/10" />
					<div className="size-8 shrink-0 rounded-sm bg-neutral-900/10 dark:bg-neutral-50/10" />
				</div>
			</SortableOverlay>
		</Sortable>
	...
	if (filter.operator === 'isEmpty' || filter.operator === 'isNotEmpty') {
		return (
			<div
				...
				aria-live="polite"
				className="h-8 w-full rounded border border-neutral-200 bg-transparent dark:bg-neutral-200/30 dark:border-neutral-800 dark:dark:bg-neutral-800/30"
			/>
		)
	}
