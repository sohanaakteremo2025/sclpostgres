...
export default function Students() {
	...
	const updatedStudents = Object.values(students).map(student => {
		...
		const startDate = feeRecord?.createdAt || student.createdAt || currentDate;
		return {
		  ...student,
		  unpaidMonths: getMonthsBetweenDates(feeRecord? feeRecord.createdAt : student.createdAt, currentDate)
		};
	  });
