...
export default function Students() {
	...
	const studentWithFees = {...students, lastPaid: Object(fees).values.map(fee=>fee.reason === 'monthlyFee')}
	const flatStudents = Object.values().map(
		(data: TStudentWithClassAndSection) => ({
			id: data.id,
